...
* Controllers are used to perform functionalities on instances of objects on the database --> controller functions imported and called on routes which allows for the for the routing of all of the CRUD operations within my app.
...
## Conclusion
* useParams() can only be used to access text variables from the URL of the current webpage, and an not be used to access or update the state of variables related to objects within your code
